...
class Canvas extends Serializer {
	...
	updateLines() {
		...
		// FIX: Get canvas position to offset viewport coordinates
		...
		for ( const link of links ) {
			...
			if ( lioElement !== null ) {
				...
				// FIX: Subtract canvas offset from viewport coordinates
				aPos.x = rect.x + rect.width - canvasOffsetX;
				aPos.y = rect.y + ( rect.height / 2 ) - canvasOffsetY;
				...
				// FIX: Subtract canvas offset from mouse coordinates when dragging
				aPos.x = this.clientX - canvasOffsetX;
				aPos.y = this.clientY - canvasOffsetY;
			...
			if ( rioElement !== null ) {
				...
				// FIX: Subtract canvas offset from viewport coordinates
				bPos.x = rect.x - canvasOffsetX;
				bPos.y = rect.y + ( rect.height / 2 ) - canvasOffsetY;
				...
				// FIX: Subtract canvas offset from mouse coordinates when dragging
				bPos.x = this.clientX - canvasOffsetX;
				bPos.y = this.clientY - canvasOffsetY;
