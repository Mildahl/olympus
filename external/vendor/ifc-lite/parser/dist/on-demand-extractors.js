...
import { RelationshipType, PropertyValueType, } from '@ifc-lite/data';
 ...
 */
export function extractPsetsFromIds(store, extractor, psetIds) {
    const result = [];
...
//# sourceMappingURL=on-demand-extractors.js.map