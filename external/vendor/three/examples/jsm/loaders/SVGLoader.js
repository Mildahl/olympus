...
class SVGLoader extends Loader {
	...
	static pointsToStrokeWithBuffers( points, style, arcDivisions, minDistance, vertices, normals, uvs, vertexOffset ) {
		...
		// Param vertexOffset: Offset vertices to start writing in the buffers (3 ViewerElements/vertex for vertices and normals, and 2 ViewerElements/vertex for uvs)
