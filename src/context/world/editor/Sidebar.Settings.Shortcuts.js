import { UIPanel, UIText, UIRow, UIInput } from '../../../../drawUI/ui.js';
...
function SidebarSettingsShortcuts( editor ) {
	...
	document.addEventListener( 'keydown', function ( event ) {
		if ( !FocusManager.canHandleViewportShortcuts() ) {
			return;
		}
		...
		switch ( event.key.toLowerCase() ) {
			...
			case '.':
				...
				console.log( 'Focus shortcut pressed with key: .' );

				console.log( 'editor.selected:', editor.selected );
